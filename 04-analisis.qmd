...
#| out-width: '100%'
#| fig-asp: 1
#| fig-cap: "Within effects of perception of inequality and meritocratic perceptions on market justice preferences"
#| fig-cap-location: top
#| echo: false
#| results: asis
...
p6 <- ggpredict(m9.1, terms = c("merit_effort_mean", "perc_inequality_mean")) %>% 
  plot() + 
...
p7 <- ggpredict(m9.2, terms = c("merit_talent_mean", "perc_inequality_mean")) %>% 
  plot() +
#  scale_x_continuous(n.breaks = 6) +
  scale_color_manual(
    name = "Perception\nInequality (BE)",
...
@tbl-interactions1 reports whether perceived economic inequality moderates the impact of meritocratic perceptions on market-justice preferences. Contrary to our hypothesis, the interaction terms in the within-person specification (Model 8 and Model 9) do not reach statistical significance. However, in the between-person specification (Model 10 and Model 11), interaction terms reach statistical significance, indicating that perceptions of economic inequality do meaningfully alter the effect of meritocracy on support for market allocation of social services. These effects are positive and mean that when the perception of inequality is greater, the positive effect of the meritocratic variables on market justice preferences is greater. These interaction effects are visualized in @fig-interact
