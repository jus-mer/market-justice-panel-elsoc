...
```
@tbl-interactions1 reports whether perceived economic inequality moderates the impact of meritocratic beliefs on market-justice preferences. In neither the within-person specification (Model 8) nor the between-person specification (Model 9) do the interaction terms reach statistical significance, indicating that higher perceptions of economic inequality do not meaningfully alter the effect of meritocracy on support for market allocation of social services.


With regard to how the effects of perceived economic inequality, meritocratic beliefs, and their interaction evolve over time...
