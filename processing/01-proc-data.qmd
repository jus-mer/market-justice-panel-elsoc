...
df_study1_long <- data.table::melt.data.table(data.table::setDT(df_study1_wide),
              ...
              variable.name = c("ola"),
              measure = patterns("^comuna_","^comunacod_","^ponderador_long_total_", "^segmento_", "^estrato_", "^just_educ_", "^just_pension_", "^just_health_", "^mjp_","^merit_effort_","^merit_talent_", "^perc_sal_gerente_", "^perc_sal_obrero_", "^just_sal_gerente_", "^just_sal_obrero_", "^perc_inequality_", "^just_inequality_", "^educ_","^educyear_","^sex_", "^age_","^ess_", "^ideo_","^nhogar1_", "^m46_nhogar_", "^m54_", "^m30_", "^m30b_", "^m29_imp_"),
              value.name = c("comuna","comunacod","ponderador_long_total","segmento","estrato", "just_educ", "just_pension","just_health","mjp","merit_effort","merit_talent", "perc_sal_gerente","perc_sal_obrero","just_sal_gerente","just_sal_obrero", "perc_inequality", "just_inequality", "educ","educyear","sex", "age", "ess", "ideo", "nhogar1", "m46_nhogar", "m54", "m30", "m30b", "m29_imp"),
...
df_study1_long <- data.table::melt.data.table(data.table::setDT(df_study1_wide),
              ...
              variable.name = c("ola"),
              measure = 
patterns("^comuna_","^comunacod_","^ponderador_long_total_", "^segmento_", "^estrato_", "^just_educ_", "^just_pension_", "^just_health_", "^mjp_","^merit_effort_","^merit_talent_", "^perc_sal_gerente_", "^perc_sal_obrero_", "^just_sal_gerente_", "^just_sal_obrero_", "^perc_inequality_", "^just_inequality_", "^educ_","^educyear_","^sex_", "^age_","^ess_", "^ideo_","^quintil_", "^quintil1_", "^ing_pc_"),
              value.name = c("comuna","comunacod","ponderador_long_total","segmento","estrato", "just_educ", "just_pension","just_health","mjp","merit_effort","merit_talent", "perc_sal_gerente","perc_sal_obrero","just_sal_gerente","just_sal_obrero", "perc_inequality", "just_inequality", "educ","educyear","sex", "age", "ess", "ideo", "quintil", "quintil1", "ing_pc"),
              na.rm = F,value.factor = TRUE
              )
```
