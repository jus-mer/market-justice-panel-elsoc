...
texreg::htmlreg(list(m1, m2, m3, m4, m5, m6, m7),
               ...
               custom.note = "\\item Note: Cells contain regression coefficients with standard errors in parentheses. %stars. \\\\ \\item Source: own elaboration with pooled data from ELSOC 2016-2023 (n = 4364).",
               threeparttable = T,
               leading.zero = T,
               float.pos = "h!",
               use.packages = F,
