...
\setstretch{1.15}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3981}}
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{07-supplementary-material_files/figure-pdf/fig-matrix-1.pdf}
...
\hline
Intercept                                                & $1.263^{***}$ & $1.264^{***}$ & $1.246^{***}$ & $1.128^{***}$ & $1.099^{***}$ & $1.090^{***}$ \\
...
Var: individuals (Intercept)                             & $0.388$       & $0.334$       & $0.379$       & $0.274$       & $0.535$       & $0.372$       \\
...
Var: idencuesta (Intercept)                        & $0.388$       & $0.343$       & $0.388$        & $0.277$      & $0.122$       & $0.405$       \\
