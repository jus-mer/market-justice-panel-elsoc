...
#| out-width: '90%'
#| fig-asp: 1
#| fig-cap: "Correlation matrix of the main variables for the first wave (2016)"
...
corrplot::corrplot(M,
                   ...
                   bg = "white",
                   na.label = "-") 
grid::grid.text("Source: own elaboration with data from ELSOC 2016 (n = 1687)", x = 0.99, y = 0.1, just = "right", gp = grid::gpar(fontsize = 12, col = "black"))
...
#| tbl-cap: "Growth curves for meritocracy, perceived economic inequality and market justice preferences"
#| tbl-cap-location: top
