...
With respect to the temporal dynamics of the key predictors, @tbl-interactions2 shows that time has no statistically significant effects on either the within- or between-person effects of perceived inequality and meritocratic perceptions. The within-person interaction effects are positive, suggesting that in later waves, the influence of perceived inequality and meritocratic beliefs on market justice preferences tends to increase. Conversely, in the between-person specification, the interaction effects are negative, indicating that over time, the impact of perceived inequality and meritocratic beliefs on support for market-based justice tends to diminish. However, these trends are not statistically significant, and thus no definitive conclusions can be drawn. 
